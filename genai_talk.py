...
prompt = f"""
    ...
    После каждого выведенного ответа, пожалуйста, пришли разбор того, как должен был браться этот вопрос используя знания из файла и логику.
    Постарайся подсказать, на какие именно слова или идеи нужно было обратить внимание.
...
class Handler(telepot.helper.ChatHandler):
    ...
    def on__idle(self, event):
        self.send_message_to_genai(message=
                                   "Пожалуйста, выведи итоговый результат"
